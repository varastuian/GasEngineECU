...
void LinkManager::setToolbox(QGCToolbox *toolbox)
{
    ...
    _ecuController =  _toolbox->ecuController();
...
// #endif
    ...
    //vahid
    // (void) connect(link.get(), &LinkInterface::bytesReceived, _ecuController, &ECUController::receiveBytes);
...
void LinkManager::_linkDisconnected()
{
    ...
    // (void) disconnect(link, &LinkInterface::bytesReceived, _ecuController, &ECUController::receiveBytes);
